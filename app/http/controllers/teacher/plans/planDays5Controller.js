...
class planDays5Controller extends controller  {
    async showPlanDays5Form(req , res){
        ...
        res.render('./teacher/plan/planDays5' , {teachersAuth , lessonses , className ,terms ,fields});
    }

    async planDays5Proccess(req , res , next) {
    ...
    async Classes(req , res){
        const classes = await Class.find({ Reserve: false , days : "چهارشنبه" })
...
module.exports = new planDays5Controller();