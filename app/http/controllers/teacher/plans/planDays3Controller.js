...
class planDays3Controller extends controller  {
    async showPlanDays3Form(req , res){
        ...
        res.render('./teacher/plan/planDays3' , {teachersAuth , lessonses , className ,terms,fields});
    }

    async planDays3Proccess(req , res , next) {
    ...
    async Classes(req , res){
        const classes = await Class.find({ Reserve: false , days : "دوشنبه" })
...
module.exports = new planDays3Controller();