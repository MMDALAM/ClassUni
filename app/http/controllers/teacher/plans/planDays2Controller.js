...
class planDays2Controller extends controller  {
    async showPlanDays2Form(req , res){
        ...
        res.render('./teacher/plan/planDays2' , {teachersAuth , lessonses , className ,terms,fields});
    }

    async planDays2Proccess(req , res , next) {
    ...
    async Classes(req , res){
        const classes = await Class.find({ Reserve: false , days : "یکشنبه" })
...
module.exports = new planDays2Controller();