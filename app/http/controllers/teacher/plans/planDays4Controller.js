...
class planDays4Controller extends controller  {
    async showPlanDays4Form(req , res){
        ...
        res.render('./teacher/plan/planDays4' , {teachersAuth , lessonses , className ,terms,fields});
    }

    async planDays4Proccess(req , res , next) {
    ...
    async Classes(req , res){
        const classes = await Class.find({ Reserve: false , days : "سه شنبه" })
...
module.exports = new planDays4Controller();