...
class PDFDocumentWithTables extends PDFDocument {
    ...
    table(table, arg0, arg1, arg2) {
        ...
        const columnSpacing = options.columnSpacing || 16;
        ...
        table.headers.forEach((header, i) => {
            this.font('fonts/iransansdn.ttf').fontSize(10).text(header, startX + i * columnContainerWidth, startY, {
                width: columnWidth,
                align: "right"
            });
        });
        ...
        this.moveTo(startX, rowBottomY - rowSpacing * 0.1)
            .lineTo(startX + usableWidth, rowBottomY - rowSpacing * 0.1)
            .lineWidth(1)
            .stroke();
